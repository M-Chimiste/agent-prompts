...
- Create a project_status.md file in the project_docs directory to track progress if it doesn't already exist.
- After each conversation or coding session, update project_status.md with:
